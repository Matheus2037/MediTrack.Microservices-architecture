...
{
    public class ConsultaModelConfiguration : EntityTypeConfiguration<Domain.Consulta.Consulta>, IEntityTypeConfiguration<Domain.Consulta.Consulta>
    {
        ...
        public void Configure(EntityTypeBuilder<Domain.Consulta.Consulta> builder)
        {
            ToTable("Consulta");
            HasKey(x => x.Id);
